...
const AllMatches: React.FC<AllMatchesProps> = ({ selectedDate, changeDate }) => {
  ...
  if (loading) return (
    <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
      ...
      <div className="text-center">
        ...
        <p className="text-sm opacity-70" style={{ color: colors.textSecondary }}>Seçilen tarihteki maçları getiriyoruz...</p>
      </div>
    </div>
  );
  ...
  if (matches.length === 0) return (
    <div className="flex flex-col items-center justify-center min-h-[400px] space-y-6">
      ...
      <div className="text-center max-w-md">
        <h3 className="text-xl font-bold mb-2" style={{ color: colors.text }}>Bu Tarihte Maç Yok</h3>
        <p className="text-sm opacity-70 mb-4" style={{ color: colors.textSecondary }}>
          Seçilen tarihte henüz maç bulunmuyor. Farklı bir tarih seçmeyi deneyebilirsiniz.
        </p>
